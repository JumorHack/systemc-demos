...
struct Bus: sc_module
{
  ...
  // Multi-socket non-blocking transport forward method (id = incoming target-socket index)
  ...
  // Multi-socket non-blocking transport backward method (id = incoming initiator-socket index)
  ...
  // Multi-socket TLM-2 blocking transport method
  ...
  // Multi-socket TLM-2 forward DMI method
  ...
  // Multi-socket debug transaction method
  ...
  // Multi-socket backward DMI method (id = originating initiator-side index)
